    ...
    return (
      <button
        ...
        className={cn(
          ...
          'bg-indigo-600 hover:bg-indigo-700 hover:shadow-lg active:scale-[0.98] active:bg-indigo-800',
          'focus:outline-none focus:ring-2 focus:ring-indigo-600/50 focus:ring-offset-2 focus:bg-indigo-700',
