    ...
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/50 p-4 pt-12">
      <div className="mx-auto mb-8 w-full max-w-3xl rounded-2xl bg-white shadow-2xl dark:bg-gray-800">
        ...
        <div className="px-6 py-5">
          ...
          {(lessonType === 'lecture' || lessonType === 'document') && (
            <div
            ...
            >
              <div className="border-b border-gray-100 px-5 py-3 dark:border-gray-700">
                <div className="flex items-center gap-2">
                  ...
                  {TYPE_META[lessonType].primaryPanel === 'attachments' && (
                    <span
                      className={`rounded-full px-2 py-0.5 text-xs font-medium ${TYPE_META[lessonType].badgeCls}`}
                    >
                      Nội dung chính
                    </span>
                  )}
                  ...
                  <div className="mt-2 flex flex-wrap items-center gap-2 text-sm">
                    {editingRandomCount ? (
                      <div className="flex items-center gap-1.5">
                        ...
                        <button
                          onClick={() =>
                            handleSaveRandomCount(randomCountInput)
                          }
